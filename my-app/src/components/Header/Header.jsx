        ...
        <header className={classes.header}>
            <div className={classes.header_inner_wrapper}>
                <div className={classes.logo_wrapper}>
                    <NavLink to="/"><img className={classes.logo} src='https://senticode.by/img/logo_v2.png' alt="logo"></img></NavLink>
                </div>
                <nav className={classes.navbar}>
                    <ul className={classes.navbar_list}>
                        ...
                        <li className={classes.navbar_list_item}><NavLink className={classes.navbar_list_item_link} activeClassName={classes.active} to="/testdialogs">TestDialogs</NavLink></li>
                    </ul>
                </nav>
            </div>
        </header>
